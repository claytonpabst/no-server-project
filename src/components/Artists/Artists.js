          ...
          <div className='artistsParent'>
            <div className='artistsHeader'>Point Studio <span>Artists</span></div>
              ...
              <Link className='artistToClick' to='/artistprofile/kourtneeg'>Kourtnee G
                <div className='artistProfilePic'>
                  <img className='theActualPic' src='./img/kourtbw.jpg'></img>
                </div>              
              </Link>
              <Link className='artistToClick' to='/artistprofile/pinkswey'>Pink Swey
                <div className='artistProfilePic'>
                  <img className='theActualPic' src='./img/pinkswey.jpg'></img>
                </div>
              </Link>
              <Link className='artistToClick' to='/artists'>Addy D
                <div className='artistProfilePic'>
              ...
              <Link className='artistToClick' to='/artistprofile/cleightyp'>cleighty_p
                <div className='artistProfilePic'>
                  <img className='theActualPic' src='./img/claysquare.jpg'></img>
                </div>
              </Link>
              <Link className='artistToClick' to='/artists'>Cherie
                <div className='artistProfilePic'>
              ...
              <Link className='artistToClick' to='/artists'>Clyp
                <div className='artistProfilePic'>
                  <img className='theActualPic' src='https://i1.sndcdn.com/avatars-000282980764-mttzmi-t500x500.jpg'></img>
                </div>              
              </Link>
              <Link className='artistToClick' to='/artists'>Last Hope
                <div className='artistProfilePic'>
                  <img className='theActualPic' src='./img/lasthope.jpg'></img>
                </div>              
              </Link>
              ...
              <Link className='artistToClick' to='/artists'>Future Band
                <div className='artistProfilePic'>
